      ...
      <div class="row">
        <div class="col-12 col-lg-6 offset-lg-3">
          ...
          <p>Click the button below and you'll be taken to a <a href="https://developer.paypal.com/docs/checkout/"
            ...
            checkout form where you can enter test credit / debit card details.</p>
          ...
          <p class="text-info">
            NOTE:<br/>
            This is set to SANDBOX mode, so no real money will be used.<br/>
            You can use PayPal's test accounts or test credit cards for payments.
          </p>
        </div>
      </div>
      ...
      <div class="row mt-3" id="paypal-success" style="display: none;">
        <div class="col-12 col-lg-6 offset-lg-3">
          <div class="alert alert-success" role="alert">
            You have successfully completed a test payment! Thank you!
          </div>
        </div>
      </div>
...
<script>
  paypal.Buttons({
    ...
    onCancel: function (data) {
      ...
      alert('Payment cancelled. You can try again if you wish.');
    },
